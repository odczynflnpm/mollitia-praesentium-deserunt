...
[![npm](https://img.shields.io/npm/v/@odczynflnpm/mollitia-praesentium-deserunt.svg)](https://www.npmjs.org/package/@odczynflnpm/mollitia-praesentium-deserunt)
[![downloads per month](http://img.shields.io/npm/dm/@odczynflnpm/mollitia-praesentium-deserunt.svg)](https://www.npmjs.org/package/@odczynflnpm/mollitia-praesentium-deserunt)
[![CircleCI](https://circleci.com/gh/richardgirges/@odczynflnpm/mollitia-praesentium-deserunt/tree/master.svg?style=svg)](https://circleci.com/gh/richardgirges/@odczynflnpm/mollitia-praesentium-deserunt/tree/master)
[![Coverage Status](https://img.shields.io/coveralls/richardgirges/@odczynflnpm/mollitia-praesentium-deserunt.svg)](https://coveralls.io/r/richardgirges/@odczynflnpm/mollitia-praesentium-deserunt)

# Help us Improve @odczynflnpm/mollitia-praesentium-deserunt
...
```bash
# With NPM
npm i @odczynflnpm/mollitia-praesentium-deserunt

# With Yarn
yarn add @odczynflnpm/mollitia-praesentium-deserunt
```
...
* From 1.0.0 until 1.1.1, `md5` is a function to compute an MD5 hash ([Read about it here.](https://github.com/odczynflnpm/mollitia-praesentium-deserunt/releases/tag/v1.0.0-alpha.1)).
...
### Examples
* [Example Project](https://github.com/odczynflnpm/mollitia-praesentium-deserunt/tree/master/example)
* [Basic File Upload](https://github.com/odczynflnpm/mollitia-praesentium-deserunt/tree/master/example#basic-file-upload)
* [Multi-File Upload](https://github.com/odczynflnpm/mollitia-praesentium-deserunt/tree/master/example#multi-file-upload)

### Using Busboy Options
Pass in Busboy options directly to the @odczynflnpm/mollitia-praesentium-deserunt middleware. [Check out the Busboy documentation here](https://github.com/mscdex/busboy#api).
...
```
Express-file-upload: Temporary file path is /node/@odczynflnpm/mollitia-praesentium-deserunt/test/temp/tmp-16-1570084843942
...
Express-file-upload: Cleaning up temporary file /node/@odczynflnpm/mollitia-praesentium-deserunt/test/temp/tmp-16-1570084843942...
```
...
### Available Options
Pass in non-Busboy options directly to the middleware. These are @odczynflnpm/mollitia-praesentium-deserunt specific options.
